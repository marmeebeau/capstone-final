...
export interface ApiCoordinatorCoordinator extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    coor_fname: Schema.Attribute.String & Schema.Attribute.Required;
    coor_lname: Schema.Attribute.String;
    coor_username: Schema.Attribute.String & Schema.Attribute.Required;
    coor_email: Schema.Attribute.Email & Schema.Attribute.Required;
    coor_password: Schema.Attribute.Password & Schema.Attribute.Required;
    coor_contact: Schema.Attribute.String;
    coor_address: Schema.Attribute.Text;
    coor_role: Schema.Attribute.Enumeration<['Admin', 'Coordinator']> &
